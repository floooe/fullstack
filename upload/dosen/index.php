...
<body>
    <h2>Data Dosen</h2> <a href="tambah.php" class="btn-add">+ Tambah Dosen</a> | <a href="../../home.php">Kembali</a>
    <table border="1">
        <tr>
            <th>No</th>
            <th>NPK</th>
        ...
        while ($data = mysqli_fetch_array($q)) { ?>
            <tr>
                ...
                <td> <a href="edit.php?npk=<?= urlencode($data['npk']); ?>">Edit</a> | <a
                        href="hapus.php?npk=<?= urlencode($data['npk']); ?>"
                        onclick="return confirm('Yakin ingin menghapus data ini?');">Hapus</a> </td>
            </tr> <?php } ?>
    </table>
    <div class="pagination"> <?php for ($i = 1; $i <= $pages; $i++) { ?> <a href="?page=<?= $i; ?>"><?= $i; ?></a>
        <?php } ?> </div>
</body>
